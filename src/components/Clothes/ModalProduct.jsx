...
export const ModalProduct = (props) => {
  ...
  useEffect(() => {
    axios.get('https://kawahedukasibackend.herokuapp.com/content/data/mukti').then(({ data }) => setCloth(data.filter((e) => e.id === props.id)[0]));
  }, [props.showModal]);
          ...
          <form method="post" encType="multipart/form-data" onSubmit={() => create()}>
            <div className="inputContainer">
              <div className="photo">
                ...
                <input type="file" id="image" name="image" placeholder="image" className="form-control" onChange={(e) => handleChange('image', e.target.files[0].name)} required />
              </div>
              <div>
                <label className="form-label normal mb-2" htmlFor="name">
                  Cloth Name
                </label>
                <input type="text" id="name" name="name" placeholder="Cloth Name" onChange={(e) => handleChange('name', e.target.value)} required />
              </div>
              <div className="description2">
                <label className="form-label normal mb-2" htmlFor="desc">
                  Description 1
                </label>
                <textarea id="description2" name="description2" className="form-control w-100" onChange={(e) => handleChange('description2', e.target.value)} />
              </div>
              <div className="description3">
                <label className="form-label normal mb-2" htmlFor="desc">
                  Description 2
                </label>
                <textarea id="description3" name="description3" className="form-control w-100" onChange={(e) => handleChange('description3', e.target.value)} />
              </div>
              ...
              <div>
                ...
                <input type="number" id="description6" name="description6" placeholder="5000000" onChange={(e) => handleChange('description6', e.target.value)} />
              </div>
            </div>
            <Button
              type="submit"
