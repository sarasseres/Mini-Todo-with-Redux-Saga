  ...
  return (
    <div>
      ...
      <div className="card shadow-lg p-0">
        <img src={props.image ? props.image : require("./../../assets/images/products/empty.jpg")} className="card-img-top rounded-0" alt="gambar" />
        <div className="card-body p-0 text-center">
          ...
          <h3 className="fw-bold mb-4">{props.price ? props.price.substr(0, 3) + "." + props.price.substr(3) + ",00" : "?"}</h3>
