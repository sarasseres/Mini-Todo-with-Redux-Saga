          ...
          <form method="post" encType="multipart/form-data" onSubmit={() => (props.id ? update() : create())}>
            <div className="inputContainer detail-img-small">
              ...
              <div className="description2">
                ...
                <textarea id="description2" name="description2" className="form-control w-100" rows="5" value={input?.description2} onChange={(e) => handleChange('description2', e.target.value)} />
              </div>
              <div className="description3">
                <label className="form-label normal mb-2" htmlFor="desc">
                  Description 2
                </label>
                <textarea id="description3" name="description3" className="form-control w-100" rows="5" value={input?.description3} onChange={(e) => handleChange('description3', e.target.value)} />
              </div>
              <div className="description4">
                ...
                <select onChange={(e) => handleChange('description4', e.target.value)} name="description4" id="description4" className="form-select">
                  ...
                  {input?.description4 === 'Jacket' ? (
                    <option selected value="Jacket">
                      Jacket
                    </option>
                  ) : (
                  ...
                  {input?.description4 === 'Outfit' ? (
                    <option selected value="Outfit">
                      Outfit
                    </option>
                  ) : (
              ...
              <div className="description5">
                ...
                <select onChange={(e) => handleChange('description5', e.target.value)} name="description5" id="description5" className="form-select">
                  ...
                  {input?.description5 === 'LADIES' ? (
                    <option selected value="LADIES">
                      Ladies
                    </option>
                  ) : (
                    <option value="LADIES">Ladies</option>
                  )}
                  {input?.description5 === 'KIDS' ? (
                    <option selected value="LADIES">
                      Kids
                    </option>
                  ) : (
                  ...
                  {input?.description5 === 'ACCESSORIES' ? (
                    <option selected value="LADIES">
                      Accessories
                    </option>
                  ) : (
