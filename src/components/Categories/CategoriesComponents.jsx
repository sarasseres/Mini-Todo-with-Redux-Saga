    ...
    <div className="row m-0 pt-2">
      ...
      <div className="col-12 p-0 row m-0">
        <div className="col-md-3 col-sm-6 p-0">
          <button onClick={()=>navigate("/categories/MEN")} className="w-100 btn btn-dark text-primary2 fw-semibold rounded-0 py-4"><h5 className="m-0">MEN</h5></button>
        </div>
        <div className="col-md-3 col-sm-6 p-0">
          <button onClick={()=>navigate("/categories/LADIES")} className="w-100 btn btn-dark text-primary2 fw-semibold rounded-0 py-4"><h5 className="m-0">LADIES</h5></button>
        </div>
        <div className="col-md-3 col-sm-6 p-0">
          <button onClick={()=>navigate("/categories/KIDS")} className="w-100 btn btn-dark text-primary2 fw-semibold rounded-0 py-4"><h5 className="m-0">KIDS</h5></button>
        </div>
        <div className="col-md-3 col-sm-6 p-0">
          <button onClick={()=>navigate("/categories/ACCESSORIES")} className="w-100 btn btn-dark text-primary2 fw-semibold rounded-0 py-4"><h5 className="m-0">ACCESSORIES</h5></button>
        </div>
      </div>
